...
## -- get the apt repo
RUN wget https://dev.mysql.com/get/mysql-apt-config_0.8.13-1_all.deb -O /workspace/mysql-apt-config_0.8.13-1_all.deb 
#  && dpkg /workspace/mysql-apt-config_0.8.13-1_all.deb
